...
pub async fn process_job(app: &AppState, job_id: Uuid) -> Result<()> {
    ...
    // Read agent settings once — controls max_tokens and reasoning_effort for all calls
    ...
    // ponytail: O(n*m) scan, deal-breakers list is <10 items
